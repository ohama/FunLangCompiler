...
## Current Milestone: v8.0 Final Parity

**Goal:** Annot/LambdaAnnot (type annotation pass-through) + ForInExpr (collection iteration loop)을 컴파일하여 LangThree 인터프리터와의 기능 차이를 해소한다

**Target features:**
- Annot: `(e : T)` type annotation pass-through (simply elaborate inner expr)
- LambdaAnnot: `fun (x: T) -> e` annotated lambda (elaborate as Lambda)
- ForInExpr: `for x in collection do body` collection iteration loop
...
---
*Last updated: 2026-03-28 after v7.0 milestone shipped*
