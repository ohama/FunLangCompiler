...
## Current Milestone: v13.0 — LangThree Typeclass Sync
...
- [ ] Typeclass 컴파일 (elaborateTypeclasses — TypeClassDecl 제거, InstanceDecl → LetDecl 변환, DerivingDecl 제거)
- [ ] Prelude/Typeclass.fun 동기화 (Show, Eq 빌트인 인스턴스)
- [ ] Typeclass E2E 테스트

## Current State

v12.0 shipped. 217 E2E tests. 12 Prelude modules.
~4,100 lines F# (Elaboration.fs), 1,343 lines C (lang_runtime.c), 12 Prelude .fun files.
에러 메시지 정확한 줄 번호, 파서 에러 위치, CHECK-RE 테스트, 비교 unboxing 완료.
...
---
*Last updated: 2026-04-01 after v12.0 milestone completed*
