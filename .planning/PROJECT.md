...
## Current Milestone: v9.0 Collections & Builtins Parity

**Goal:** LangThree v7.0/v7.1에서 추가된 컬렉션 타입, 빌트인 함수, 언어 구문을 컴파일러에 구현하여 LangThree Phase 62까지 패리티 달성

**Target features:**
- 새 컬렉션 타입: StringBuilder, HashSet, Queue, MutableList (C runtime)
- 새 빌트인 함수: string_endswith/startswith/trim, hashtable_trygetvalue/count, list_sort_by/of_seq, array_sort/of_seq, char 함수 6종, string_concat_list, eprintfn
- 새 언어 구문: string slicing, list comprehension, for-in 패턴 분해, 새 컬렉션 for-in
- Prelude 모듈 확장: String/Hashtable/StringBuilder/Char/List/Array/Option/Result 모듈 함수

## Current State

v8.0 shipped. 144 E2E tests. LangThree feature parity through Phase 51. Phases 52-62 remain.
...
- printf/sprintf 포맷 문자열 — 복잡도 높음
- FileImportDecl (multi-file import) — 재귀적 파서 호출 필요
- get_args — @main 시그니처 변경 필요 (argc/argv)
...
---
*Last updated: 2026-03-29 after v9.0 milestone started*
