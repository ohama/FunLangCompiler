# Roadmap: FunLangCompiler v11.0 — Compiler Error Messages
...
**Success Criteria** (what must be TRUE):
  ...
  2. Parser error messages include position information (token index; true line:col requires upstream FunLang fix)
