# Requirements Archive: v21.0 Partial Env Pattern

**Archived:** 2026-04-02
**Status:** SHIPPED

This is the archived requirements specification for v21.0.
...
**Adjusted:** TEST-02 revised — nested LetRec capturing outer param unsupported; redesigned to two sequential LetRec bodies sharing template global
**Dropped:** None
