...
|---------------------------------------------------|---------------------------------------------------|------------|-------------------------------------------------------------------------------------------|
| `src/LangBackend.Compiler/MlirIR.fs`              | `LlvmGEPDynamicOp` DU case                        | VERIFIED   | Line 59: `LlvmGEPDynamicOp of result: MlirValue * ptr: MlirValue * index: MlirValue`     |
| `src/LangBackend.Compiler/Printer.fs`             | Printer arm for `LlvmGEPDynamicOp`                | VERIFIED   | Lines 97-99: emits `llvm.getelementptr %ptr[%idx] : (!llvm.ptr, i64) -> !llvm.ptr, i64` |
| `src/LangBackend.Compiler/lang_runtime.c`         | Four C array functions                             | VERIFIED   | Lines 161-211: `lang_array_create`, `lang_array_bounds_check`, `lang_array_of_list`, `lang_array_to_list` all implemented |
| `src/LangBackend.Compiler/lang_runtime.h`         | `LangCons` forward decl + 4 function declarations  | VERIFIED   | Line 28: `typedef struct LangCons LangCons;`; Lines 29-32: all four function declarations |
| `src/LangBackend.Compiler/Elaboration.fs`         | 6 array builtin elaboration cases + ExternalFuncDecl entries | VERIFIED | Lines 802-879: all six cases (array_set, array_get, array_create, array_length, array_of_list, array_to_list); ExternalFuncDecl entries at both ~2134 and ~2271 |
