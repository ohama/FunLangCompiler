...
- `/Users/ohama/vibe-coding/LangBackend/src/LangBackend.Cli/Program.fs` -- Parser invocation and fallback logic (lines 29-52)
- `/Users/ohama/vibe-coding/LangBackend/src/LangBackend.Compiler/Pipeline.fs` -- MLIR temp file management (lines 77-114)
...
- `/Users/ohama/vibe-coding/LangBackend/survey/langthree-span-zeroing-fix.md` -- Upstream span zeroing analysis

### Secondary (MEDIUM confidence)
- `/Users/ohama/vibe-coding/LangBackend/.planning/phases/44-error-location-foundation/44-VERIFICATION.md` -- Phase 44 findings on span zeroing
